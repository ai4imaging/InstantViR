...
import zipfile
from instantvir.evaluation.coco_eval import cleanfid
from instantvir.evaluation.coco_eval.cleanfid.utils import *
from instantvir.evaluation.coco_eval.cleanfid.features import build_feature_extractor, get_reference_statistics
from instantvir.evaluation.coco_eval.cleanfid.resize import *
...
def make_custom_stats(name, fdir, num=None, mode="clean", model_name="inception_v3",
    ...
    if model_name == "inception_v3":
        ...
        from instantvir.evaluation.coco_eval.cleanfid.clip_features import CLIP_fx, img_preprocess_clip
