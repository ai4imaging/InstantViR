...
from instantvir.evaluation.coco_eval.cleanfid.fid import get_batch_features, fid_from_feats
from instantvir.evaluation.coco_eval.cleanfid.resize import build_resizer
